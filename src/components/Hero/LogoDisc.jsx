    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            mm.add('(prefers-reduced-motion: no-preference)', () => {
                ...
                // the logo's own forever tumble — 3-axis (X/Y/Z), at the
                // logo's rate from discSpin.js (paired with the case's,
                // which turns at a different rate). Spins continuously from
                ...
                const ambientTumble = createTumble(ambientGroup, DISC_SPIN.logo.seconds, { onUpdate: syncShadowToSpin });
